# IDVerse Face Scan Example with Vue 3 + TypeScript + Vite
...
In the file `src/App.vue` there is a method being called which name is `defineCustomElements`.
...
in the file `src/components/Main.vue` you will need to add this prop as follow (considering where we copied the assets in previous step)
